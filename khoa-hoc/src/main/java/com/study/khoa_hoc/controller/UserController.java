...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<UserResponse>> getById(@PathVariable Long id) {
        ...
        // return ResponseEntity.ok(new ApiResponse<>(2000, "Tìm thấy
        // user",userResponse));
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable Long id, @Valid @RequestBody UserUpdateRequest userRequest) {
